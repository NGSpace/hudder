...
public interface InGameHudAccessor {
    ...
    @Invoker public void callRenderJumpMeter(PlayerRideableJumping playerRideableJumping, GuiGraphics guiGraphics, int i);
    @Invoker public void callRenderSelectedItemName(GuiGraphics context);
    @Invoker public void callRenderItemHotbar(GuiGraphics guiGraphics, DeltaTracker deltaTracker);
}
