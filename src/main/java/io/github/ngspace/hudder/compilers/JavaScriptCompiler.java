...
//			Hudder.log(context.getEngine().getClass());
//		}
...
//            }
            ...
            cx.evaluateString(scope, s, "hud.js", 1, null);
...
//            System.err.println(Context.toString(cx.fun));
            return CompileResult.of(result.toString());
