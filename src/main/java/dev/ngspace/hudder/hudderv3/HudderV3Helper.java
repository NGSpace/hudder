...
public class HudderV3Helper {
	...
	public static HudderConfig config = Hudder.config;
	...
	public static float getDefaultScale() {return config.scale();}
	public static int getMaxWhile() {return !config.unsafeoperations() ? Short.MAX_VALUE : -1;}
