...
public class V2ArrayRead extends AV2Value {
	...
	public V2ArrayRead(String value, AV2Compiler compiler, V2Runtime runtime, int line, int charpos, String debugvalue) throws ExecutionException {
	...
	@Override public Object get() throws ExecutionException {
		...
		throw new ExecutionException(invalidTypeMessage("Array", value, get), line, charpos);
	}
